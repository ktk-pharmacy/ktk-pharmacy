        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <!-- table table-striped -->
                    <form action="{{ route('content_update', $content->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group mt-3">
                                    <input type="text" class="form-control" name="title"
                                        placeholder="Enter content title" value="{{ old('title', $content->title) }}"
                                        required>
                                </div>
                            </div> <!-- end col -->
                                ...
                                <div class="mt-3">
                                    <select name="content_type" class="select2 form-control " id="">
                                        @foreach ($content_types as $type)
                                            <option value="{{ $type->id }}" @selected($content->content_type_id == $type->id)>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-7">
                                ...
                                <textarea name="description" class="summernote">{!! old('description', $content->description) !!}</textarea>
                            </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="file" id="image" name="image" data-max-file-size="1000K"
                                    ...
                                    class="form-control" data-default-file={{ $content->image_url }}>

                                <div class="mt-3">
                                    <div class="checkbox checkbox-success checkbox-circle mb-2">
                                        <input id="category_status" type="checkbox" name="status"
                                            @checked($content->status) value="1">
