                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="Enter Title Here" id="title" name="title"
                                        class="form-control" value="{{ old('title', $service->title) }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="Enter Title Here" id="title_mm" name="title_mm"
                                        class="form-control" value="{{ old('title_mm', $service->title_mm) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Service Description</label>
                                    {{-- <input type="text" placeholder="Enter Name Here" id="description" name="description"
                                class="form-control" value="{{ old('description') }}"> --}}
                                    <textarea name="description" id="description" class="form-control" placeholder="Enter Description Here" rows="12">{{ old('description', $service->description) }}</textarea>
                                </div>

                                <div class="mb-3">
                                    <div class="checkbox checkbox-success checkbox-circle mb-2">
                                        <input id="status" type="checkbox" name="status"
                                            @checked($service->status) value="1">
                                        <label for="status">
                                            Active
                                        </label>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="image" name="image" data-max-file-size="1000K"
                                        ...
                                        data-default-file='{{ $service->image_url }}' class="form-control">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="dropify" id="" name="bg_url"
                                        ...
                                        data-allowed-file-extensions='["png", "PNG", "jpg", "JPG", "jpeg", "JPEG"]'
                                        class="form-control" data-default-file="{{ $service->bg_url }}">
                                </div>
                            </div>
